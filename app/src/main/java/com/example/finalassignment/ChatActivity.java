...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        IvDiscussionTopics = (ListView) findViewById(R.id.IvDiscussionTopics);
        arrayAdpt = new ArrayAdapter(this, android.R.layout.simple_list_item_1, listOfDiscussion);
        IvDiscussionTopics.setAdapter(arrayAdpt);
        getUserName();
        ...
        IvDiscussionTopics.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
